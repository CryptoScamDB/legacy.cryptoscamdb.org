...
export default scam => {
    ...
    if ('subcategory' in scam && scam.subcategory === 'MyEtherWallet') {
        abusereport +=
            'The domain is impersonating MyEtherWallet.com, a website where people can create Ethereum wallets (a cryptocurrency like Bitcoin).';
    } else if ('subcategory' in scam && scam.subcategory === 'MyCrypto') {
        abusereport +=
            'The domain is impersonating MyCrypto.com, a website where people can create Ethereum wallets (a cryptocurrency like Bitcoin).';
    } else if ('subcategory' in scam && scam.subcategory === 'Classic Ether Wallet') {
        abusereport +=
            'The domain is impersonating classicetherwallet.com, a website where people can create Ethereum Classic wallets (a cryptocurrency like Bitcoin).';
    } else if ('category' in scam && scam.category === 'Fake ICO') {
        abusereport +=
            "The domain is impersonating a website where an ICO is being held (initial coin offering, like an initial public offering but it's for cryptocurrencies).";
    }
